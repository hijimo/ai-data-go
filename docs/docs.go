                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/AIQARequestSwagger"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "问答成功",
                        "schema": {
                            "$ref": "#/definitions/LexiangAIQADataResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/AISearchRequestSwagger"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "搜索成功",
                        "schema": {
                            "$ref": "#/definitions/LexiangAISearchDataResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
    ...
    "definitions": {
        "AIQARequestSwagger": {
            ...
            "properties": {
                ...
                "targets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/AITargetSwagger"
                    }
                }
            }
        },
        ...
        "ChatHistoryMessage": {
            ...
            "properties": {
                ...
                "role": {
                    "description": "角色：user（用户）或 assistant（AI助手）\n@Description 消息发送者的角色\n@Example user",
                    "type": "string",
                    "enum": [
                        "user",
                        "assistant",
        ...
        "ChatRequest": {
            ...
            "properties": {
                "history": {
                    "description": "历史消息（可选，用于多轮对话）\n@Description 历史对话消息列表，按时间顺序排列",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ChatHistoryMessage"
                    }
                },
                "message": {
        ...
        "LexiangAIQADataResponse": {
            ...
            "properties": {
                ...
                "data": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/LexiangAIQAResponse"
                        }
                    ]
                },
                "message": {
        ...
        "LexiangAIQAResponse": {
            ...
            "properties": {
                "additionalContent": {
                    "$ref": "#/definitions/LexiangAdditionalContent"
                },
                "answerSource": {
                    "type": "string",
                    "example": "internal"
        ...
        "LexiangAISearchDataResponse": {
            ...
            "properties": {
                ...
                "data": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/LexiangAISearchResponse"
                        }
                    ]
                },
                "message": {
        ...
        "LexiangAISearchResponse": {
            "type": "object",
            "properties": {
                "list": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/LexiangAISearchResultItem"
                    }
                }
            }
        },
        "LexiangAISearchResultItem": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string",
                ...
                "url": {
                    "type": "string",
                    "example": "https://lexiang.tencent.com/kb/entry/123"
                }
            }
        },
        "LexiangAdditionalContent": {
            "type": "object",
            "properties": {
                "generatedQuestion": {
                    "type": "string",
                ...
                "referenceChunks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/LexiangReferenceChunk"
                    }
                },
                "referenceDocs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/LexiangReferenceDoc"
                    }
                }
            }
        },
