...
// ContextBuildOutputResponse 上下文构建输出响应（用于 Swagger）
// @name ContextBuildOutputResponse
// 注意：使用 interface{} 避免与 internal/genkit/flows 包的循环依赖
type ContextBuildOutputResponse = ResponseData[interface{}]

// MemorySearchOutputResponse 记忆检索输出响应（用于 Swagger）
// @name MemorySearchOutputResponse
type MemorySearchOutputResponse = ResponseData[interface{}]

// MemoryStoreOutputResponse 记忆存储输出响应（用于 Swagger）
// @name MemoryStoreOutputResponse
type MemoryStoreOutputResponse = ResponseData[interface{}]

// MemoryCleanupOutputResponse 记忆清理输出响应（用于 Swagger）
// @name MemoryCleanupOutputResponse
type MemoryCleanupOutputResponse = ResponseData[interface{}]

// TokenBudgetOutputResponse Token预算输出响应（用于 Swagger）
// @name TokenBudgetOutputResponse
type TokenBudgetOutputResponse = ResponseData[interface{}]

// TokenOptimizeOutputResponse Token优化输出响应（用于 Swagger）
// @name TokenOptimizeOutputResponse
type TokenOptimizeOutputResponse = ResponseData[interface{}]

// TokenAnalysisOutputResponse Token分析输出响应（用于 Swagger）
// @name TokenAnalysisOutputResponse
type TokenAnalysisOutputResponse = ResponseData[interface{}]

// SummaryGenerateOutputResponse 摘要生成输出响应（用于 Swagger）
// @name SummaryGenerateOutputResponse
type SummaryGenerateOutputResponse = ResponseData[interface{}]

// SummaryTriggerOutputResponse 摘要触发检查输出响应（用于 Swagger）
// @name SummaryTriggerOutputResponse
type SummaryTriggerOutputResponse = ResponseData[interface{}]

// ChatGenerateOutputResponse 对话生成输出响应（用于 Swagger）
// @name ChatGenerateOutputResponse
type ChatGenerateOutputResponse = ResponseData[interface{}]
