...
**描述**:
在 model_configurations 表中准备测试数据，用于开发和测试。

**验收标准**:

- [ ] 为测试租户创建 Google AI (Gemini) 配置
- [ ] 为测试租户创建 Azure OpenAI 配置
- [ ] 为测试租户创建阿里云百炼配置
- [ ] 验证所有配置的 API 密钥有效
- [ ] 记录测试数据的租户ID和模型名称
...
- `scripts/seed_test_model_configs.sql`

---

### TASK-1.2: 调研 Genkit 插件支持
...
- [ ] 调研 Google AI (Gemini) 插件
- [ ] 调研 Azure OpenAI 插件支持情况
- [ ] 调研阿里云百炼插件支持情况
- [ ] 确定每个提供商的集成方案
- [ ] 记录调研结果和决策
